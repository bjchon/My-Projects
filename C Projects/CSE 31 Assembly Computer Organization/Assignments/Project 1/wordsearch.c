                ...
                if(((word+0)[k] == (*(arr + i)+0)[j]) || ((word+0)[k]) == (*(arr + i)+0)[j] +32)
                    {
                        ...
                        if(j +1 == strlen(*(arr + 0)) && i==0)
                            {
                                j--;
                                i++;
                                goto begin;
                            }
                        if(j+1 == strlen(*(arr + 0)) &&  i+1==strlen(*(arr + 0)))
                            {
                                j--;
                                i--;
                                goto begin;
                        ...
                        begin:
                        if(count<1 && ((word+0)[k+1] == (*(arr + i)+0)[j]) || ((word+0)[k+1]) == (*(arr + i)+0)[j] +32)
                            {*(*(array +i) + j) = 10*(*(*(array +i) + j)) + k +2;
                                    k++;
                                if(k+1==strlen((word+0)))
                                    goto print;
